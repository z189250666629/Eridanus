...
import pprint
from core.event.events import GroupMessageEvent, PrivateMessageEvent, FriendRequestEvent, GroupRequestEvent, \
    LifecycleMetaEvent
from core.message.message_components import Record, Text, Image, File, Node, Mface
...
logger = get_logger()
STREAMING_MEDIA_CACHE_DIR = (
    Path(__file__).resolve().parent.parent / "streaming_media" / "service" / "Link_parsing" / "data"
)
