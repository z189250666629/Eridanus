    ...
    async def get_posts(self, retry: bool = True) -> Tuple[BaseApiStatus, Optional[List[str]]]:
        ...
        try:
            ...
            if is_incorrect_return(e):
                ...
                logger.error(f"米游币任务 - 获取文章列表: 请求失败")
