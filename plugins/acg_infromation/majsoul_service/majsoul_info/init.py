...
from plugins.acg_infromation.majsoul_service.majsoul_info.majsoul_Spider import getID, gettriID
from plugins.acg_infromation.majsoul_service.majsoul_info.processData import printBasicInfo, printExtendInfo, \
    printRecordInfo
