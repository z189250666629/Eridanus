...
from plugins.acg_infromation.service.majsoul.majsoul_info.init import majsoulInfo, TrimajsoulInfo, RecordInfo, TriRecordInfo
import copy


def _get_manage_group_status():
...
async def check_for_majsoul_personal_info(context,type=0,target_id=None,target_name=None,room_set=None):
    ...
    manage_group_status = _get_manage_group_status()
