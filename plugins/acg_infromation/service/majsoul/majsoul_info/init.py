...
from plugins.acg_infromation.service.majsoul.majsoul_info.majsoul_Spider import getID, gettriID
from plugins.acg_infromation.service.majsoul.majsoul_info.processData import printBasicInfo, printExtendInfo, \
    printRecordInfo
