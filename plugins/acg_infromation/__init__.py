...
"""
dynamic_imports={
    "plugins.acg_infromation.bangumi": ["call_bangumi_search"],
    "plugins.acg_infromation.character_identify": ["call_character_identify"],
    "plugins.acg_infromation.func_collection": [
