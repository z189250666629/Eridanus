...
from plugins.ai_llm.aiReplyHandler.default import defaultModelRequest
from plugins.ai_llm.aiReplyHandler.gemini import construct_gemini_standard_prompt, \
    get_current_gemini_prompt
from plugins.ai_llm.aiReplyHandler.openai import construct_openai_standard_prompt, \
    get_current_openai_prompt, construct_openai_standard_prompt_old_version
from plugins.ai_llm.aiReplyHandler.tecentYuanQi import construct_tecent_standard_prompt, YuanQiTencent
...
def _get_tts_client():
    ...
    if _tts_client is None:
        _tts_client = import_module("plugins.ai_voice.tts").TTS()
    return _tts_client
